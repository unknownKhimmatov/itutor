    ...
    return (
        <div className='subjectandtuition'>
            <div className="item-subjectandtuintion">
                ...
                <div className="table">
                    <div className="place-subjectandtuition">
                ...
                <div className="all-tuition">
                    <p>Смотреть все дисциплины и цены <i class='bx bx-down-arrow-alt'></i></p>
                </div>
            </div>
        </div>
    )
